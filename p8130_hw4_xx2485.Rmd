...
The shape of the distribution for variable `totalcost` is extremely left-skewed, but after log transformation, it follows roughly a normal distribution shape.
